...
11. `0011_profile_onboarding.sql` — social links, intent tags, and onboarding timestamps. Existing profiles are marked finished so current members are not prompted.
