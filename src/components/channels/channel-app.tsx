  ...
  return (
    <div className="relative border border-[var(--line)]">
        ...
        <input
          ...
          placeholder={
            threadOf
              ...
              : "Write to the house — DEMO compose. Absolutely no soliciting."
          }
          aria-label="Message"
        />
      ...
      <p className="px-4 pb-3 text-[11px] text-ivory-dim">
        {streamNote ?? "Private member communication, not end-to-end encryption. Absolutely no soliciting. Ban with no refund."}
      </p>
    </div>
  );
}
