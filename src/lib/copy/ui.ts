...
export const SOURCE_HUMAN = "Introduction";

export const ADD_A_TRIP = "Add a trip";
export const INDEX_TAB_FOR_YOU = "For you";
export const INDEX_TAB_CIRCLE = "Your Circle";
export const INDEX_TAB_ALL = "All members";
